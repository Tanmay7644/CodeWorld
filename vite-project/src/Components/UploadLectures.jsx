...
const UploadLectures = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post(`${import.meta.env.VITE_API_URL}/upload/lectures`, formData, {
        ...
        <div className='upload'>
            <form onSubmit={handleSubmit} className='upload-form'>
                ...
                <div className='upload-form__header'>
                    ...
                    <div>
                        <p className='upload-form__title'>Upload Lectures</p>
                        <p className='upload-form__subtitle'>Share video lectures with your students</p>
                    </div>
                </div>
                ...
                >
                    ...
                    {fileName
                        ...
                        : <>
                            ...
                            <p className='upload-form__drop-sub'>or <span>browse files</span> · MP4, MOV, AVI up to 2 GB</p>
                          </>
                    }
