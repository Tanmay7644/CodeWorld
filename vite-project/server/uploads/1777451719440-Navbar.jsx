...
//     <header className='navbar-header'>
//       <nav className='navbar-nav'>
//         <img src={logo} className="logo" alt="Code World" onClick={() => navigate("/")} />
//         <ul className="navbar-ul">
//           <li className="navbar-li">About</li>
//           <li className="navbar-li">Contact</li>
//         </ul>
//       </nav>
//       <div className="navbar-button">
//         <button className="navbar-btn navbar-btn-outline" onClick={() => navigate('/login')}>Login</button>
//         <button className="navbar-btn navbar-btn-filled" onClick={() => navigate('/register')}>Register</button>
//       </div>
//     </header>
//   );
// };
